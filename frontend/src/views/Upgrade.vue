    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <Card class="rounded-2xl relative overflow-hidden" :class="!isPro ? 'border-green-200 dark:border-green-800' : ''">
        ...
        <CardContent class="space-y-4">
          <ul class="space-y-2">
            <li v-for="f in $tm('settings.freeFeatures')" :key="f.text" class="flex items-start gap-2 text-sm">
      ...
      <Card class="rounded-2xl relative overflow-hidden" :class="isPro ? 'border-blue-200 dark:border-blue-800' : ''">
        ...
        <CardContent class="space-y-4">
          <ul class="space-y-2">
            <li v-for="f in $tm('settings.proFeatures')" :key="f.text" class="flex items-start gap-2 text-sm">
